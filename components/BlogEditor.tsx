...
const BlogEditor = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        setCoverImageName(null), setContent("");
      }
  ...
  return (
    <div className="p-4 rounded-lg shadow-md">
      <h1 className="heading">
        Create a New <span className="text-purple">Blog Post</span>
      </h1>
        ...
        <div className="w-full">
          <div className="mb-4">
            ...
            <input
              ...
              className="border border-[#151518] bg-[#151518] rounded-md p-2 w-full"
              placeholder="Add cover image"
            />
          </div>
          {coverImageName && (
            <span className="ml-4 text-sm text-white-100">
              {coverImageName}
            </span>
          )}
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="border border-[#151518] bg-[#151518] text-white rounded-md p-2 w-full"
          ...
          {/* Content Editor */}
          <ReactQuill
            className="bg-[#151518] mb-4 text-white custom-quill"
            value={content}
            onChange={setContent}
          ...
          <Button
            ...
            className="mt-8 bg-purple text-white cursor-pointer font-semibold py-2 px-4 rounded-md w-full"
          >
